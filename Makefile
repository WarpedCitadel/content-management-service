...
IMAGE_NAME =content-management-service
...
\n\
To manage a container for content-management-service, use one of these targets.\n\
Ensure you have a .env file to map secrets for content-management-service application.properties file.\n\
...
rip_deploy_local:
	...
	@echo "Building container content-management-service..."
	docker compose up wc_local --build -d